...
`api` is synced from https://xxxxx/blob/{branch}/staging/src/github.com/clusterpedia-io/api. Code changes are made in that location, merged into `xxxxx` and later synced here.

## Things you should *NOT* do

1. https://xxxxx/blob/{branch}/staging/src/github.com/clusterpedia-io/api is synced to `xxxxx`. All changes must be made in the former. The latter is read-only.
...
1. git clone https://xxxxx.git (always make a fresh copy since it will damage your repo)
2. cd clusterpedia
