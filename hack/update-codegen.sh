...
client-gen \
    ...
    --output-pkg="xxxxx/pkg/generated/clientset" \
...
lister-gen \
    ...
    --output-pkg="xxxxx/pkg/generated/listers" \
    --plural-exceptions="ClusterSyncResources:ClusterSyncResources" \
...
informer-gen \
    --go-header-file="hack/boilerplate.go.txt" \
    --versioned-clientset-package="xxxxx/pkg/generated/clientset/versioned" \
    --listers-package="xxxxx/pkg/generated/listers" \
    --output-dir="pkg/generated/informers" \
    --output-pkg="xxxxx/pkg/generated/informers" \
    --plural-exceptions="ClusterSyncResources:ClusterSyncResources" \
    github.com/clusterpedia-io/api/cluster/v1alpha2 github.com/clusterpedia-io/api/policy/v1alpha1
...
openapi-gen \
    ...
    --output-pkg="xxxxx/pkg/generated/openapi" \
