...
import (
	...
	"xxxxx/cmd/controller-manager/app/config"
	"xxxxx/cmd/controller-manager/app/options"
	"xxxxx/pkg/controller"
	"xxxxx/pkg/controller/clusterimportpolicy"
	"xxxxx/pkg/controller/pediaclusterlifecycle"
	...
	clusterpediafeature "xxxxx/pkg/utils/feature"
	"xxxxx/pkg/version/verflag"
)
